                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('questions.create') }}" class="btn btn-primary"
                               style="border-radius: 20px">Add Question</a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-250px">Questions</th>
                            <th class="min-w-100px">Answer 1</th>
                            <th class="min-w-100px">Answer 2</th>
                            <th class="min-w-100px">Answer 3</th>
                            <th class="min-w-100px">Answer 4</th>
                            ...
                            @foreach($exercise->questions as $question)
                                <tr>
                                    ...
                                    @foreach($question->answers as $index => $answer)
                                        <td class="{{ $answer->is_correct ? 'bg-success text-white' : '' }}">
                                            {{ $answer->answer_text }}
                                        </td>
                                    @endforeach
                                    <td>
                                        <div class="d-flex justify-content-center flex-shrink-0">
                                            <form method="post"
                                                  action="{{ route('questions.destroy', $exercise->id) }}">
                                                @csrf
                                                @method("DELETE")
                                                <button type="submit"
