    ...
    <div class="aside-menu flex-column-fluid ">
        ...
        <div class="my-5 hover-scroll-overlay-y my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            {{--    <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::routeIs('category.index') || Request::routeIs('category.create') || Request::routeIs('category.edit') ? 'active' : '' }}"
                        ...
                        <span class="menu-title fs-5">Category</span>
                    </a>
                </div>
                <div class="menu-item">
