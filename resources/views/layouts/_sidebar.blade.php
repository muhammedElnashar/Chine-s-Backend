        ...
        <div class="my-5 hover-scroll-overlay-y my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
              ...
              <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::routeIs('users.index') || Request::routeIs('users.create') || Request::routeIs('users.edit') ? 'active' : '' }}"
                        ...
                        <span class="menu-title fs-5">Admins</span>
                    </a>
                </div>
                @endif
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::routeIs('announcements.index') || Request::routeIs('announcements.create') || Request::routeIs('announcements.edit') ? 'active' : '' }}"
                        ...
                        <span class="menu-title fs-5">Announcements</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::routeIs('words.index') || Request::routeIs('words.create') ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::routeIs('courses.index') || Request::routeIs('courses.create')|| Request::routeIs('courses.edit') ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::routeIs('payments.index') || Request::routeIs('payments.create')|| Request::routeIs('payments.edit') ? 'active' : '' }}"
                        ...
                        <span class="menu-title fs-5">Payments</span>
                    </a>
                </div>
