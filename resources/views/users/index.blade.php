                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('users.create') }}" class="btn btn-primary" style="border-radius: 20px">Add User</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_courses_table">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    @if($user->image)
                                        <img src="{{ Storage::disk('s3')->url($user->image) }}" width="50" height="50" alt="Course Image">
                                    @endif
                                </td>
