        ...
        <div id="kt_content_container" class="container-xl">
            <div class="card mx-auto" style="border-radius: 25px;">
                <div class="card-header border-0 pt-6 d-flex justify-content-between align-items-center">
                    <h3 class="card-title fw-bolder">Edit Section</h3>
                ...
                <div class="card-body pt-6">
                    <form method="POST" action="{{ route('courses.levels.update', [$course, $level]) }}">
                        ...
                        <div class="mb-7">
                            ...
                            <textarea name="description" class="form-control form-control-solid mb-2" rows="4" placeholder="Enter Section Description">{{ old('description', $level->description) }}</textarea>
